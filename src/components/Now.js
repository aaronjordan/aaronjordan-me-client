  ...
  return (
    <main className="content">
      <section className="card">
        ...
        <p>
          I'm in Austin, Texas, living out my long-standing dream of being a hipster cowboy. I am enjoying a great learning opportunity though my work as a frontend developer at General Motors and have fallen in love with the city of Austin.
        </p><p>
        ...
        </p><p>To support that goal, this is what I spend my time doing:
        </p>
        <ul className="space">
          <li>Being a stable support and loving husband to my wife, Mazlin Jordan</li>
        ...
        <p className="ctr">As my priorities change and come into focus, I update this list.<br />The most recent update was on October 2, 2021.</p>
